function init() {
    ...
    }, mapElement = document.getElementById("map"), map = new google.maps.Map(mapElement,mapOptions), addresses = ["Brooklyn"], x = 0; x < addresses.length; x++)
...
if (function(a, b) {
    ...
    function Va(a, b, c) {
        ...
        j = n.css(a, "display"),
        "inline" === ("none" === j ? L.get(a, "olddisplay") || ta(a.nodeName) : j) && "none" === n.css(a, "float") && (o.display = "inline-block")),
    ...
    n.extend({
        ...
        ready: function(a) {
            ...
            !0 !== a && --n.readyWait > 0 || (H.resolveWith(l, [n]),
    ...
    n.fn.extend({
        ...
        promise: function(a, b) {
            ...
            a = void 0),
            a = a || "fx"; g--; )
                (c = L.get(f[g], a + "queueHooks")) && c.empty && (d++,
                c.empty.add(h));
            return h(),
            e.promise(b)
        }
        ...
        trigger: function(b, c, d, e) {
            ...
            e || !o.trigger || !1 !== o.trigger.apply(d, c))) {
                ...
                for (f = 0; (g = p[f++]) && !b.isPropagationStopped(); )
                    ...
                    m && m.apply(g, c),
                    (m = k && g[k]) && m.apply && n.acceptData(g) && (b.result = m.apply(g, c),
                    !1 === b.result && b.preventDefault());
                return b.type = q,
                e || b.isDefaultPrevented() || o._default && !1 !== o._default.apply(p.pop(), c) || !n.acceptData(d) || k && n.isFunction(d[q]) && !n.isWindow(d) && (h = d[k],
                h && (d[k] = null),
                n.event.triggered = q,
                d[q](),
            ...
            !k.preDispatch || !1 !== k.preDispatch.call(this, a)) {
                ...
                b = 0; (f = h[b++]) && !a.isPropagationStopped(); )
                    ...
                    c = 0; (g = f.handlers[c++]) && !a.isImmediatePropagationStopped(); )
                        ...
                        a.data = g.data,
                        void 0 !== (e = ((n.event.special[g.origType] || {}).handle || g.handler).apply(f.elem, i)) && !1 === (a.result = e) && (a.preventDefault(),
                        a.stopPropagation()));
        ...
        domManip: function(a, b) {
            ...
            d)) {
                ...
                if (g)
                    ...
                    j = 0; g > j; j++)
                        h = f[j],
                        fa.test(h.type || "") && !L.access(h, "globalEval") && n.contains(i, h) && (h.src ? n._evalUrl && n._evalUrl(h.src) : n.globalEval(h.textContent.replace(/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, "")))
            }
            return this
        }
    }),
    ...
    n.extend({
        attr: function(a, b, c) {
            ...
            if (a && 3 !== f && 8 !== f && 2 !== f)
                ...
                d = n.attrHooks[b] || (n.expr.match.bool.test(b) ? Za : void 0)),
    ...
    Za = {
        set: function(a, b, c) {
            return !1 === b ? n.removeAttr(a, c) : a.setAttribute(c, c),
            c
        }
    },
    ...
    n.extend({
        ...
        ajax: function(a, b) {
            ...
            v.success = v.done,
            v.error = v.fail,
            k.url = ((a || k.url || ob) + "").replace(/#.*$/, "").replace(/^\/\//, pb[1] + "//"),
            ...
            delete k.data),
            !1 === k.cache && (k.url = fb.test(d) ? d.replace(fb, "$1_=" + cb++) : d + (db.test(d) ? "&" : "?") + "_=" + cb++)),
        ...
        _findParticles: function() {
            ...
            this.options.parallaxElements && this.$element.find("[data-stellar-ratio]").each(function() {
                ...
                m.parents().each(function() {
                    var b = a(this);
                    return !0 === b.data("stellar-offset-parent") ? (n = p,
                    o = q,
                    j = b,
                    !1) : (p += b.position().left,
        ...
        _findBackgrounds: function() {
            ...
            b.each(function() {
                ...
                o.parents().each(function() {
                    var b = a(this);
                    return !0 === b.data("stellar-offset-parent") ? (q = s,
                    r = t,
                    l = b,
                    !1) : (s += b.position().left,
...
function($) {
    $.fn.hoverIntent = function(handlerIn, handlerOut, selector) {
        ...
        var cX, cY, pX, pY, track = function(ev) {
            ...
            if (ob.hoverIntent_t = clearTimeout(ob.hoverIntent_t),
            Math.abs(pX - cX) + Math.abs(pY - cY) < cfg.sensitivity)
                return $(ob).off("mousemove.hoverIntent", track),
                ob.hoverIntent_s = 1,
            ...
            return ob.hoverIntent_t = clearTimeout(ob.hoverIntent_t),
            ob.hoverIntent_s = 0,
            cfg.out.apply(ob, [ev])
        }, handleHover = function(e) {
            var ev = jQuery.extend({}, e)
              , ob = this;
            ob.hoverIntent_t && (ob.hoverIntent_t = clearTimeout(ob.hoverIntent_t)),
            "mouseenter" == e.type ? (pX = ev.pageX,
            pY = ev.pageY,
            $(ob).on("mousemove.hoverIntent", track),
            1 != ob.hoverIntent_s && (ob.hoverIntent_t = setTimeout(function() {
                compare(ev, ob)
            }, cfg.interval))) : ($(ob).off("mousemove.hoverIntent", track),
            1 == ob.hoverIntent_s && (ob.hoverIntent_t = setTimeout(function() {
                delay(ev, ob)
            }, cfg.timeout)))
        };
    ...
    var methods = function() {
        var c = {
          ...
          , toggleMenuClasses = function($menu, o) {
            ...
            o.cssArrows && (classes += " " + c.menuArrowClass),
          ...
          , applyHandlers = function($menu, o) {
            ...
            unprefixedPointerEvents && (touchevent = "pointerdown.superfish"),
            ios || (touchevent += " touchend.superfish"),
            wp7 && (touchevent += " mousedown.superfish"),
            $menu.on("focusin.superfish", "li", over).on("focusout.superfish", "li", out).on(touchevent, "a", o, touchHandler)
        }
          , touchHandler = function(e) {
            var $this = $(this)
              , $ul = $this.siblings(e.data.popUpSelector);
            $ul.length > 0 && $ul.is(":hidden") && ($this.one("click.superfish", !1),
            "MSPointerDown" === e.type || "pointerdown" === e.type ? $this.trigger("focus") : $.proxy(over, $this.parent("li"))())
        }
          , over = function() {
            var $this = $(this)
              , o = getOptions($this);
          ...
          , out = function() {
            var $this = $(this)
              , o = getOptions($this);
            ios ? $.proxy(close, $this, o)() : (clearTimeout(o.sfTimer),
            o.sfTimer = setTimeout($.proxy(close, $this, o), o.delay))
        }
          , close = function(o) {
            o.retainPath = $.inArray(this[0], o.$path) > -1,
            this.superfish("hide"),
            this.parents("." + o.hoverClass).length || (o.onIdle.call(getMenu(this)),
            o.$path.length && $.proxy(over, o.$path)())
        }
          , getMenu = function($el) {
        ...
        return {
            ...
            destroy: function() {
                return this.each(function() {
                    var $hasPopUp, $this = $(this), o = $this.data("sf-options");
                    if (!o)
                        return !1;
...
function(e) {
    var t, n, i, o, r, a, s, l = "Close", c = "BeforeClose", p = "MarkupParse", f = "Open", m = "Change", g = "mfp", h = "." + g, v = "mfp-ready", C = "mfp-removing", y = "mfp-prevent-close", w = function() {}, b = !!window.jQuery, I = e(window), x = function(e, n) {
        t.ev.on(g + e + h, n)
    }, k = function(t, n, i, o) {
    ...
    var isiPad = function() {
      ...
      , offcanvas = function() {
        ...
        $(window).resize(function() {
            ...
            w.width() > 769 && $("body").hasClass("fh5co-offcanvas") && $("body").removeClass("fh5co-offcanvas")
        })
    }
      ...
      , contentWayPoint = function() {
        ...
        $(".animate-box").waypoint(function(direction) {
            "down" !== direction || $(this.element).hasClass("animated") || (i++,
      ...
      , stickyBanner = function() {
        ...
        var countDownDate = new Date("Sep 09, 2026 14:00:00").getTime();
            ...
            var x = setInterval(function() {
                ...
                var days = Math.floor(distance / 864e5); // 864e5 = milliseconds in a day
                var hours = Math.floor(distance % 864e5 / 36e5); // 36e5 = milliseconds in an hour
                var minutes = Math.floor(distance % 36e5 / 6e4); // 6e4 = milliseconds in a minute
                var seconds = Math.floor(distance % 6e4 / 1e3); // 1e3 = milliseconds in a second
                ...
                if (distance < 0) {
                    clearInterval(x);
                    // Update the display when the countdown ends
                    document.getElementById("demo").innerHTML = "The Wedding Ceremony is Over";
                }
            }, 1000);         
      //, countDownDate = new Date("Sep 09, 2026 14:00:00").getTime()
...
var google;
if (google.maps.event.addDomListener(window, "load", init),
window.Modernizr = function(a, b, c) {
    ...
    function I(a, b, d) {
        for (var e in a) {
            var f = b[a[e]];
            if (f !== c)
                return !1 === d ? a[e] : F(f, "function") ? f.bind(d || b) : f
        }
        return !1
    }
    function J(a, b, c) {
    ...
    var x, C, e = {}, g = b.documentElement, h = "modernizr", i = b.createElement(h), j = i.style, k = b.createElement("input"), l = ":)", m = {}.toString, n = " -webkit- -moz- -o- -ms- ".split(" "), o = "Webkit Moz O ms", p = o.split(" "), q = o.toLowerCase().split(" "), r = {
...
function(a) {
    ...
    !c.mediaQueriesSupported) {
        var g, h, i, j = a.document, k = j.documentElement, l = [], m = [], n = [], o = {}, q = j.getElementsByTagName("head")[0] || k, r = j.getElementsByTagName("base")[0], s = q.getElementsByTagName("link"), t = function() {
            ...
            for (var v in l)
                if (l.hasOwnProperty(v)) {
                    var w = l[v]
                      ...
                      , z = null === x
                      , A = null === y;
                    x && (x = parseFloat(x) * (x.indexOf("em") > -1 ? i || t() : 1)),
                    y && (y = parseFloat(y) * (y.indexOf("em") > -1 ? i || t() : 1)),
...
function(t, e) {
    ...
    function l(t, e, n) {
        ...
        if (void 0 === n && 1 === t.nodeType)
            if (i = "data-" + e.replace(mt, "-$1").toLowerCase(),
    ...
    function w(t) {
        var e = G
          , n = jt[t];
        return n || (n = b(t, e),
        "none" !== n && n || (Lt = (Lt || J("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement),
    ...
    function S(t, e, n, i, o) {
        for (var r = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0, s = 0; 4 > r; r += 2)
            ...
            i ? ("content" === n && (s -= J.css(t, "padding" + yt[r], !0, o)),
            "margin" !== n && (s -= J.css(t, "border" + yt[r] + "Width", !0, o))) : (s += J.css(t, "padding" + yt[r], !0, o),
            "padding" !== n && (s += J.css(t, "border" + yt[r] + "Width", !0, o)));
        return s
    }
    function E(t, e, n) {
        var i = !0
    ...
    function $(t, e) {
        for (var n, i, o, r = [], s = 0, a = t.length; a > s; s++)
            i = t[s],
            i.style && (r[s] = dt.get(i, "olddisplay"),
            n = i.style.display,
            e ? (r[s] || "none" !== n || (i.style.display = ""),
            "" === i.style.display && bt(i) && (r[s] = dt.access(i, "olddisplay", w(i.nodeName)))) : (o = bt(i),
            "none" === n && o || dt.set(i, "olddisplay", o ? n : J.css(i, "display"))));
        for (s = 0; a > s; s++)
            i = t[s],
    ...
    function P(t, e, n) {
        var i, o, r, s, a, l, c, u = this, p = {}, f = t.style, d = t.nodeType && bt(t), h = dt.get(t, "fxshow");
        ...
        c = J.css(t, "display"),
        "inline" === ("none" === c ? dt.get(t, "olddisplay") || w(t.nodeName) : c) && "none" === J.css(t, "float") && (f.display = "inline-block")),
    ...
    function L(t, e, n) {
        var i, o, r = 0, s = Kt.length, a = J.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (o)
                return !1;
            for (var e = Ut || O(), n = Math.max(0, c.startTime + c.duration - e), i = n / c.duration || 0, r = 1 - i, s = 0, l = c.tweens.length; l > s; s++)
                c.tweens[s].run(r);
    ...
    function j(t) {
        return function(e, n) {
            "string" != typeof e && (n = e,
            e = "*");
            var i, o = 0, r = e.toLowerCase().match(ct) || [];
            if (J.isFunction(n))
                for (; i = r[o++]; )
                    "+" === i[0] ? (i = i.slice(1) || "*",
        ...
        a--); l > a; a++)
            if (null != (t = arguments[a]))
                for (e in t)
                    n = s[e],
                    i = t[e],
                    s !== i && (c && i && (J.isPlainObject(i) || (o = J.isArray(i))) ? (o ? (o = !1,
    ...
    J.extend({
        ...
        proxy: function(t, e) {
            ...
            e = t,
            t = n),
            J.isFunction(t) ? (i = W.call(arguments, 2),
            o = function() {
    ...
    var et = function(t) {
        function e(t, e, n, i) {
            ...
            if ((e ? e.ownerDocument || e : M) !== A && O(e),
            e = e || A,
            n = n || [],
            a = e.nodeType,
            ...
            if (!i && P) {
                    ...
                    if (s = o[1]) {
                        if (9 === a) {
                            ...
                            if (r.id === s)
                                return n.push(r),
                                n
                        } else if (e.ownerDocument && (r = e.ownerDocument.getElementById(s)) && _(e, r) && r.id === s)
                            return n.push(r),
                            n
                    } else {
                        if (o[2])
                ...
                if (b.qsa && (!D || !D.test(t))) {
                    ...
                    1 === a && "object" !== e.nodeName.toLowerCase()) {
                        for (p = C(t),
                        (f = e.getAttribute("id")) ? d = f.replace(yt, "\\$&") : e.setAttribute("id", d),
                        d = "[id='" + d + "'] ",
                        c = p.length; c--; )
                            p[c] = d + u(p[c]);
        ...
        function g(t, e, n, o, r, s) {
            ...
            r && !r[H] && (r = g(r, s)),
            i(function(i, s, a, l) {
                var c, u, p, f = [], g = [], m = s.length, v = i || d(e || "*", a.nodeType ? [a] : a, []), y = !t || !i && e ? v : h(v, f, t, a, l), b = n ? r || (i ? t : m || o) ? [] : s : y;
                if (n && n(y, b, a, l),
                o)
                    for (c = h(b, g),
                    o(c, [], a, l),
                ...
                if (i) {
                    if (r || t) {
                        ...
                        for (u = b.length; u--; )
                            (p = b[u]) && (c = r ? Z(i, p) : f[u]) > -1 && (i[c] = !(s[c] = p))
                    }
                } else
        ...
        function v(t, n) {
            var o = n.length > 0
              ...
              , s = function(i, s, a, l, c) {
                var u, p, f, d = 0, g = "0", m = i && [], v = [], y = E, b = i || r && w.find.TAG("*", c), x = R += null == y ? 1 : Math.random() || .1, T = b.length;
        ...
        var y, b, w, x, T, C, k, S, E, $, I, O, A, N, P, D, L, j, _, H = "sizzle" + 1 * new Date, M = t.document, R = 0, F = 0, z = n(), q = n(), W = n(), B = function(t, e) {
            return t === e && (I = !0),
            0
        }, U = 1 << 31, Q = {}.hasOwnProperty, V = [], X = V.pop, Y = V.push, K = V.push, G = V.slice, Z = function(t, e) {
            for (var n = 0, i = t.length; i > n; n++)
                if (t[n] === e)
                    return n;
            return -1
        }, J = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", tt = "[\\x20\\t\\r\\n\\f]", et = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", nt = et.replace("w", "w#"), it = "\\[" + tt + "*(" + et + ")(?:" + tt + "*([*^$|!~]?=)" + tt + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + nt + "))|)" + tt + "*\\]", ot = ":(" + et + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + it + ")*)|.*)\\)|)", rt = new RegExp(tt + "+","g"), st = new RegExp("^" + tt + "+|((?:^|[^\\\\])(?:\\\\.)*)" + tt + "+$","g"), at = new RegExp("^" + tt + "*," + tt + "*"), lt = new RegExp("^" + tt + "*([>+~]|" + tt + ")" + tt + "*"), ct = new RegExp("=" + tt + "*([^\\]'\"]*?)" + tt + "*\\]","g"), ut = new RegExp(ot), pt = new RegExp("^" + nt + "$"), ft = {
            ID: new RegExp("^#(" + et + ")"),
            CLASS: new RegExp("^\\.(" + et + ")"),
        ...
        }, dt = /^(?:input|select|textarea|button)$/i, ht = /^h\d$/i, gt = /^[^{]+\{\s*\[native \w/, mt = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, vt = /[+~]/, yt = /'|\\/g, bt = new RegExp("\\\\([\\da-f]{1,6}" + tt + "?|(" + tt + ")|.)","ig"), wt = function(t, e, n) {
            var i = "0x" + e - 65536;
        ...
        O = e.setDocument = function(t) {
            ...
            L = [],
            D = [],
            (b.qsa = gt.test(i.querySelectorAll)) && (o(function(t) {
                N.appendChild(t).innerHTML = "<a id='" + H + "'></a><select id='" + H + "-\f]' msallowcapture=''><option selected=''></option></select>",
                t.querySelectorAll("[msallowcapture^='']").length && D.push("[*^$]=" + tt + "*(?:''|\"\")"),
                t.querySelectorAll("[selected]").length || D.push("\\[" + tt + "*(?:value|" + J + ")"),
                t.querySelectorAll("[id~=" + H + "-]").length || D.push("~="),
            ...
            _ = e || gt.test(N.contains) ? function(t, e) {
            ...
            B = e ? function(t, e) {
                ...
                1 & n || !b.sortDetached && e.compareDocumentPosition(t) === n ? t === i || t.ownerDocument === M && _(M, t) ? -1 : e === i || e.ownerDocument === M && _(M, e) ? 1 : $ ? Z($, t) - Z($, e) : 0 : 4 & n ? -1 : 1)
            }
            : function(t, e) {
                if (t === e)
                    return I = !0,
                ...
                if (!r || !a)
                    return t === i ? -1 : e === i ? 1 : r ? -1 : a ? 1 : $ ? Z($, t) - Z($, e) : 0;
                if (r === a)
                    return s(t, e);
        ...
        e.contains = function(t, e) {
            return (t.ownerDocument || t) !== A && O(t),
            _(t, e)
        }
        ,
        e.attr = function(t, e) {
        ...
        w = e.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(t) {
                    var e, n = !t[6] && t[2];
                    return ft.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : n && ut.test(n) && (e = C(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e),
                    t[2] = n.slice(0, e)),
                    t.slice(0, 3))
                }
            },
            filter: {
                ...
                CHILD: function(t, e, n, i, o) {
                    ...
                    : function(e, n, l) {
                        var c, u, p, f, d, h, g = r !== s ? "nextSibling" : "previousSibling", m = e.parentNode, v = a && e.nodeName.toLowerCase(), y = !l && !a;
                        if (m) {
                            if (r) {
                                for (; g; ) {
                                    for (p = e; p = p[g]; )
                            ...
                            } else if (y && (c = (e[H] || (e[H] = {}))[t]) && c[0] === R)
                                f = c[1];
                            else
                                for (; (p = ++d && p && p[g] || (f = d = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++f || (y && ((p[H] || (p[H] = {}))[t] = [R, f]),
                                p !== e)); )
                                    ;
        ...
        S = e.select = function(t, e, n, i) {
            var o, r, s, a, c, p = "function" == typeof t && t, f = !i && C(t = p.selector || t);
            if (n = n || [],
            1 === f.length) {
                if (r = f[0] = f[0].slice(0),
                r.length > 2 && "ID" === (s = r[0]).type && b.getById && 9 === e.nodeType && P && w.relative[r[1].type]) {
            ...
            return (p || k(t, f))(i, e, !P, n, vt.test(t) && l(e.parentNode) || e),
            n
        }
        ,
    ...
    (J.fn.init = function(t, e) {
        ...
        if ("string" == typeof t) {
            if (!(n = "<" === t[0] && ">" === t[t.length - 1] && t.length >= 3 ? [null, t, null] : st.exec(t)) || !n[1] && e)
                return !e || e.jquery ? (e || rt).find(t) : this.constructor(e).find(t);
            if (n[1]) {
                if (e = e instanceof J ? e[0] : e,
                J.merge(this, J.parseHTML(n[1], e && e.nodeType ? e.ownerDocument || e : G, !0)),
                it.test(n[1]) && J.isPlainObject(e))
                    for (n in e)
                        J.isFunction(this[n]) ? this[n](e[n]) : this.attr(n, e[n]);
                return this
            }
            return i = G.getElementById(n[2]),
        ...
        this.length = 1,
        this) : J.isFunction(t) ? void 0 !== rt.ready ? rt.ready(t) : t(J) : (void 0 !== t.selector && (this.selector = t.selector,
    ...
    J.extend({
        ...
        when: function(t) {
            ...
            if (s > 1)
                ...
                n = new Array(s),
                i = new Array(s); s > o; o++)
                    r[o] && J.isFunction(r[o].promise) ? r[o].promise().done(c(o, i, r)).fail(l.reject).progress(c(o, n, e)) : --a;
    ...
    J.extend({
        ...
        ready: function(t) {
            ...
            !0 !== t && --J.readyWait > 0 || (pt.resolveWith(G, [J]),
            J.fn.triggerHandler && (J(G).triggerHandler("ready"),
            J(G).off("ready"))))
        }
    }),
    J.ready.promise = function(e) {
        return pt || (pt = J.Deferred(),
        "complete" === G.readyState ? setTimeout(J.ready) : (G.addEventListener("DOMContentLoaded", s, !1),
            ...
            return "object" == typeof t ? this.each(function() {
                ...
                if (r && void 0 === e) {
                    if (void 0 !== (n = ht.get(r, t)))
                        return n;
                    if (void 0 !== (n = ht.get(r, i)))
                        return n;
                    if (void 0 !== (n = l(r, i, void 0)))
                        return n
                } else
                    this.each(function() {
                        var n = ht.get(this, i);
                        ht.set(this, i, e),
                        -1 !== t.indexOf("-") && void 0 !== n && ht.set(this, t, e)
                    })
    ...
    J.extend({
        queue: function(t, e, n) {
            ...
            i = dt.get(t, e),
            n && (!i || J.isArray(n) ? i = dt.access(t, e, J.makeArray(n)) : i.push(n)),
            i || []) : void 0
        },
    ...
    J.event = {
        ...
        add: function(t, e, n, i, o) {
            ...
            if (m)
                ...
                c = e.length; c--; )
                    ...
                    (f = l[d]) || (f = l[d] = [],
                    f.delegateCount = 0,
                    p.setup && !1 !== p.setup.call(t, i, h, s) || t.addEventListener && t.addEventListener(d, s, !1)),
            ...
            if (m && (l = m.events)) {
                ...
                c = e.length; c--; )
                    ...
                    d) {
                        ...
                        s && !f.length && (p.teardown && !1 !== p.teardown.call(t, h, m.handle) || J.removeEvent(t, d, m.handle),
                        delete l[d])
                    } else
                        for (d in l)
                            J.event.remove(t, d + e[c], n, i, !0);
                J.isEmptyObject(l) && (delete m.handle,
                dt.remove(t, "events"))
            }
        },
        trigger: function(e, n, i, o) {
            var r, s, a, l, c, u, p, f = [i || G], d = Y.call(e, "type") ? e.type : e, h = Y.call(e, "namespace") ? e.namespace.split(".") : [];
            if (s = a = i = i || G,
            3 !== i.nodeType && 8 !== i.nodeType && !kt.test(d + J.event.triggered) && (d.indexOf(".") >= 0 && (h = d.split("."),
            d = h.shift(),
            h.sort()),
            c = d.indexOf(":") < 0 && "on" + d,
            ...
            o || !p.trigger || !1 !== p.trigger.apply(i, n))) {
                if (!o && !p.noBubble && !J.isWindow(i)) {
                    ...
                    kt.test(l + d) || (s = s.parentNode); s; s = s.parentNode)
                        f.push(s),
                        a = s;
                ...
                for (r = 0; (s = f[r++]) && !e.isPropagationStopped(); )
                    ...
                    u && u.apply(s, n),
                    (u = c && s[c]) && u.apply && J.acceptData(s) && (e.result = u.apply(s, n),
                    !1 === e.result && e.preventDefault());
                return e.type = d,
                o || e.isDefaultPrevented() || p._default && !1 !== p._default.apply(f.pop(), n) || !J.acceptData(i) || c && J.isFunction(i[d]) && !J.isWindow(i) && (a = i[c],
                a && (i[c] = null),
                J.event.triggered = d,
                i[d](),
        ...
        dispatch: function(t) {
            t = J.event.fix(t);
            var e, n, i, o, r, s = [], a = W.call(arguments), l = (dt.get(this, "events") || {})[t.type] || [], c = J.event.special[t.type] || {};
            if (a[0] = t,
            ...
            !c.preDispatch || !1 !== c.preDispatch.call(this, t)) {
                ...
                e = 0; (o = s[e++]) && !t.isPropagationStopped(); )
                    ...
                    n = 0; (r = o.handlers[n++]) && !t.isImmediatePropagationStopped(); )
                        ...
                        t.data = r.data,
                        void 0 !== (i = ((J.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, a)) && !1 === (t.result = i) && (t.preventDefault(),
                        t.stopPropagation()));
    ...
    J.Event = function(t, e) {
        ...
        this.type = t.type,
        this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && !1 === t.returnValue ? c : u) : this.type = t,
        e && J.extend(this, e),
    ...
    J.extend({
        ...
        buildFragment: function(t, e, n, i) {
            ...
            for (u.textContent = "",
            f = 0; o = p[f++]; )
                if ((!i || -1 === J.inArray(o, i)) && (l = J.contains(o.ownerDocument, o),
    ...
    J.fn.extend({
        ...
        domManip: function(t, e) {
            t = B.apply([], t);
            var n, i, o, r, s, a, l = 0, c = this.length, u = this, p = c - 1, f = t[0], g = J.isFunction(f);
            if (g || c > 1 && "string" == typeof f && !K.checkClone && At.test(f))
                return this.each(function(n) {
                    var i = u.eq(n);
                    g && (t[0] = f.call(this, n, i.html())),
                    i.domManip(t, e)
                });
            if (c && (n = J.buildFragment(t, this[0].ownerDocument, !1, this),
            i = n.firstChild,
            ...
            i)) {
                ...
                if (r)
                    ...
                    l = 0; r > l; l++)
                        s = o[l],
                        Nt.test(s.type || "") && !dt.access(s, "globalEval") && J.contains(a, s) && (s.src ? J._evalUrl && J._evalUrl(s.src) : J.globalEval(s.textContent.replace(/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, "")))
            }
            return this
        }
    }),
    ...
    var Lt, jt = {}, _t = /^margin/, Ht = new RegExp("^(" + vt + ")(?!px)[a-z%]+$","i"), Mt = function(e) {
    ...
    J.extend({
        ...
        style: function(t, e, n, i) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                ...
                "string" === r && (o = zt.exec(n)) && (n = (o[1] + 1) * o[2] + parseFloat(J.css(t, e)),
                r = "number"),
                void (null != n && n === n && ("number" !== r || J.cssNumber[a] || (n += "px"),
                K.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (l[e] = "inherit"),
    ...
    J.fx.step = {};
    var Ut, Qt, Vt = /^(?:toggle|show|hide)$/, Xt = new RegExp("^(?:([+-])=|)(" + vt + ")([a-z%]*)$","i"), Yt = /queueHooks$/, Kt = [P], Gt = {
        "*": [function(t, e) {
    ...
    J.fn.extend({
        ...
        finish: function(t) {
            return !1 !== t && (t = t || "fx"),
            this.each(function() {
                var e, n = dt.get(this), i = n[t + "queue"], o = n[t + "queueHooks"], r = J.timers, s = i ? i.length : 0;
                for (n.finish = !0,
                J.queue(this, t, []),
    ...
    J.extend({
        attr: function(t, e, n) {
            ...
            if (t && 3 !== r && 8 !== r && 2 !== r)
                return typeof t.getAttribute === xt ? J.prop(t, e, n) : (1 === r && J.isXMLDoc(t) || (e = e.toLowerCase(),
                i = J.attrHooks[e] || (J.expr.match.bool.test(e) ? Zt : void 0)),
    ...
    J.fn.extend({
        ...
        toggleClass: function(t, e) {
            ...
            : function() {
                if ("string" === n)
                    for (var e, i = 0, o = J(this), r = t.match(ct) || []; e = r[i++]; )
                        o.hasClass(e) ? o.removeClass(e) : o.addClass(e);
                else
                    (n === xt || "boolean" === n) && (this.className && dt.set(this, "__className__", this.className),
                    this.className = this.className || !1 === t ? "" : dt.get(this, "__className__") || "")
            }
            )
        },
        hasClass: function(t) {
    ...
    J.fn.extend({
        val: function(t) {
            var e, n, i, o = this[0];
            return arguments.length ? (i = J.isFunction(t),
            ...
            })) : o ? (e = J.valHooks[o.type] || J.valHooks[o.nodeName.toLowerCase()],
            ...
            select: {
                get: function(t) {
                    for (var e, n, i = t.options, o = t.selectedIndex, r = "select-one" === t.type || 0 > o, s = r ? null : [], a = r ? o + 1 : i.length, l = 0 > o ? a : r ? o : 0; a > l; l++)
                        if (n = i[l],
                        !(!n.selected && l !== o || (K.optDisabled ? n.disabled : null !== n.getAttribute("disabled")) || n.parentNode.disabled && J.nodeName(n.parentNode, "optgroup"))) {
                            if (e = J(n).val(),
                            r)
                                return e;
                            s.push(e)
    ...
    J.extend({
        ...
        ajax: function(t, e) {
            function n(t, e, n, s) {
                ...
                g.fireWith(f, [x, T]),
                c && (d.trigger("ajaxComplete", [x, p]),
                --J.active || J.event.trigger("ajaxStop")))
            }
            "object" == typeof t && (e = t,
            t = void 0),
            e = e || {};
            var i, o, r, s, a, l, c, u, p = J.ajaxSetup({}, e), f = p.context || p, d = p.context && (f.nodeType || f.jquery) ? J(f) : J.event, h = J.Deferred(), g = J.Callbacks("once memory"), m = p.statusCode || {}, v = {}, y = {}, b = 0, w = "canceled", x = {
                readyState: 0,
            ...
            x.success = x.done,
            x.error = x.fail,
            p.url = ((t || p.url || fe) + "").replace(/#.*$/, "").replace(/^\/\//, de[1] + "//"),
            p.type = e.method || e.type || p.method || p.type,
            p.dataTypes = J.trim(p.dataType || "*").toLowerCase().match(ct) || [""],
            null == p.crossDomain && (l = le.exec(p.url.toLowerCase()),
            p.crossDomain = !(!l || l[1] === de[1] && l[2] === de[2] && (l[3] || ("http:" === l[1] ? "80" : "443")) === (de[3] || ("http:" === de[1] ? "80" : "443")))),
            ...
            o = p.url,
            p.hasContent || (p.data && (o = p.url += (ie.test(o) ? "&" : "?") + p.data,
            delete p.data),
            !1 === p.cache && (p.url = oe.test(o) ? o.replace(oe, "$1_=" + ne++) : o + (ie.test(o) ? "&" : "?") + "_=" + ne++)),
            ...
            send: function(n, i) {
                ...
                e = function(t) {
                    return function() {
                        ...
                        "abort" === t ? r.abort() : "error" === t ? i(r.status, r.statusText) : i(be[r.status] || r.status, r.statusText, "string" == typeof r.responseText ? {
                            text: r.responseText
    ...
    J.ajaxPrefilter("json jsonp", function(e, n, i) {
        ...
        return a || "jsonp" === e.dataTypes[0] ? (o = e.jsonpCallback = J.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback,
        a ? e[a] = e[a].replace(Te, "$1" + o) : !1 !== e.jsonp && (e.url += (ie.test(e.url) ? "&" : "?") + e.jsonp + "=" + o),
    ...
    J.offset = {
        setOffset: function(t, e, n) {
            var i, o, r, s, a, l, c, u = J.css(t, "position"), p = J(t), f = {};
    ...
    J.fn.extend({
        offset: function(t) {
            ...
            J.contains(e, i) ? (typeof i.getBoundingClientRect !== xt && (o = i.getBoundingClientRect()),
            n = z(r),
            {
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var t = this.offsetParent || ke; t && !J.nodeName(t, "html") && "static" === J.css(t, "position"); )
                    t = t.offsetParent;
                return t || ke
            })
        }
    ...
    J.each(["top", "left"], function(t, e) {
        J.cssHooks[e] = T(K.pixelPosition, function(t, n) {
            return n ? (n = x(t, e),
            Ht.test(n) ? J(t).position()[e] + "px" : n) : void 0
        })
    }),
    J.each({
        Height: "height",
...
function(t) {
    ...
    n.prototype.getState = function(t, e, n, i) {
        ...
        if (null != n && "top" == this.affixed)
            return n > o && "top";
        if ("bottom" == this.affixed)
            return null != n ? !(o + this.unpin <= r.top) && "bottom" : !(t - i >= o + s) && "bottom";
...
function() {
    ...
    e.prototype.refresh = function() {
        ...
        for (var r in t) {
            var s = t[r];
            for (var a in this.waypoints[r]) {
                var l, c, u, p, f, d = this.waypoints[r][a], h = d.options.offset, g = d.triggerPoint, m = 0, v = null == g;
                ...
                p = c && u,
                f = !c && !u,
                !v && p ? (d.queueTrigger(s.backward),
                i[d.group.id] = d.group) : !v && f ? (d.queueTrigger(s.forward),
                i[d.group.id] = d.group) : v && s.oldScroll >= d.triggerPoint && (d.queueTrigger(s.forward),
...
function(t, e, n, i) {
    ...
    o.prototype = {
        ...
        _findParticles: function() {
            ...
            this.particles = [],
            this.options.parallaxElements && this.$element.find("[data-stellar-ratio]").each(function() {
                var n, o, r, s, a, l, c, u, p, f = t(this), d = 0, h = 0, g = 0, m = 0;
                ...
                f.data("stellar-startingLeft") ? (f.css("left", f.data("stellar-startingLeft")),
                f.css("top", f.data("stellar-startingTop"))) : (f.data("stellar-startingLeft", f.css("left")),
                ...
                f.parents().each(function() {
                    var e = t(this);
                    return !0 === e.data("stellar-offset-parent") ? (d = g,
                    h = m,
                    c = e,
                    !1) : (g += e.position().left,
                    void (m += e.position().top))
                }),
                n = f.data("stellar-horizontal-offset") !== i ? f.data("stellar-horizontal-offset") : c !== i && c.data("stellar-horizontal-offset") !== i ? c.data("stellar-horizontal-offset") : e.horizontalOffset,
                o = f.data("stellar-vertical-offset") !== i ? f.data("stellar-vertical-offset") : c !== i && c.data("stellar-vertical-offset") !== i ? c.data("stellar-vertical-offset") : e.verticalOffset,
                e.particles.push({
                    $element: f,
                    $offsetParent: c,
        ...
        _findBackgrounds: function() {
            ...
            e.each(function() {
                var e, s, a, l, c, u, p, h = t(this), g = d(h), m = 0, v = 0, y = 0, b = 0;
                if (h.data("stellar-backgroundIsActive")) {
                    if (h.data("stellar-backgroundIsActive") !== this)
                        return
                } else
                    h.data("stellar-backgroundIsActive", this);
                h.data("stellar-backgroundStartingLeft") ? f(h, h.data("stellar-backgroundStartingLeft"), h.data("stellar-backgroundStartingTop")) : (h.data("stellar-backgroundStartingLeft", g[0]),
                ...
                e = h.data("stellar-horizontal-offset") !== i ? h.data("stellar-horizontal-offset") : p !== i && p.data("stellar-horizontal-offset") !== i ? p.data("stellar-horizontal-offset") : n.horizontalOffset,
                s = h.data("stellar-vertical-offset") !== i ? h.data("stellar-vertical-offset") : p !== i && p.data("stellar-vertical-offset") !== i ? p.data("stellar-vertical-offset") : n.verticalOffset,
                n.backgrounds.push({
                    $element: h,
                    $offsetParent: p,
        ...
        _reset: function() {
            ...
            for (o = this.backgrounds.length - 1; o >= 0; o--)
                ...
                i.$element.data("stellar-backgroundStartingLeft", null).data("stellar-backgroundStartingTop", null),
        ...
        _repositionElements: function() {
            var t, e, n, i, o, r, s, a, l, c, u = this._getScrollLeft(), p = this._getScrollTop(), d = !0, h = !0;
            if (this.currentScrollLeft !== u || this.currentScrollTop !== p || this.currentWidth !== this.viewportWidth || this.currentHeight !== this.viewportHeight) {
                ...
                c = this.particles.length - 1; c >= 0; c--)
                    ...
                    this.options.verticalScrolling ? (s = (p + t.verticalOffset + this.viewportOffsetTop + t.startingPositionTop - t.startingOffsetTop + t.parentOffsetTop) * -(t.stellarRatio + e - 1) + t.startingPositionTop,
                    l = s - t.startingPositionTop + t.startingOffsetTop) : (s = t.startingPositionTop,
                    l = t.startingOffsetTop),
                    this.options.hideDistantElements && (h = !this.options.horizontalScrolling || a + t.width > (t.isFixed ? 0 : u) && a < (t.isFixed ? 0 : u) + this.viewportWidth + this.viewportOffsetLeft,
                    d = !this.options.verticalScrolling || l + t.height > (t.isFixed ? 0 : p) && l < (t.isFixed ? 0 : p) + this.viewportHeight + this.viewportOffsetTop),
                    h && d ? (t.isHidden && (this.options.showElement(t.$element),
                    t.isHidden = !1),
                ...
                for (c = this.backgrounds.length - 1; c >= 0; c--)
                    ...
                    o = this.options.verticalScrolling ? (p + n.verticalOffset - this.viewportOffsetTop - n.startingOffsetTop + n.parentOffsetTop - n.startingBackgroundPositionTop) * (e - n.stellarRatio) + "px" : n.startingValueTop,
                    f(n.$element, i, o)
            }
        },
        _handleScrollEvent: function() {
    ...
    t.fn.hoverIntent = function(e, n, i) {
        ...
        var r, s, a, l, c = function(t) {
            ...
            Math.abs(a - r) + Math.abs(l - s) < o.sensitivity)
                return t(n).off("mousemove.hoverIntent", c),
                n.hoverIntent_s = 1,
                o.over.apply(n, [e]);
            a = r,
            l = s,
            ...
            "mouseenter" == e.type ? (a = n.pageX,
            l = n.pageY,
            t(i).on("mousemove.hoverIntent", c),
            1 != i.hoverIntent_s && (i.hoverIntent_t = setTimeout(function() {
                u(n, i)
            }, o.interval))) : (t(i).off("mousemove.hoverIntent", c),
            1 == i.hoverIntent_s && (i.hoverIntent_t = setTimeout(function() {
                p(n, i)
            }, o.timeout)))
        };
...
function(t, e) {
    ...
    var n = function() {
        var n = {
          ...
          , s = function(t, e) {
            var i = n.menuClass;
            e.cssArrows && (i += " " + n.menuArrowClass),
            t.toggleClass(i)
        }
          , a = function(e, i) {
          ...
          , u = function(e, n) {
            ...
            e.on("focusin.superfish", "li", f).on("focusout.superfish", "li", d).on(a, "a", n, p)
        }
          , p = function(e) {
            var n = t(this)
              , i = n.siblings(e.data.popUpSelector);
            i.length > 0 && i.is(":hidden") && (n.one("click.superfish", !1),
            "MSPointerDown" === e.type || "pointerdown" === e.type ? n.trigger("focus") : t.proxy(f, n.parent("li"))())
        }
          , f = function() {
            var e = t(this)
              , n = m(e);
          ...
          , d = function() {
            var e = t(this)
              , n = m(e);
            i ? t.proxy(h, e, n)() : (clearTimeout(n.sfTimer),
            n.sfTimer = setTimeout(t.proxy(h, e, n), n.delay))
        }
          , h = function(e) {
            e.retainPath = t.inArray(this[0], e.$path) > -1,
            this.superfish("hide"),
            this.parents("." + e.hoverClass).length || (e.onIdle.call(g(this)),
            e.$path.length && t.proxy(f, e.$path)())
        }
          , g = function(t) {
        ...
        return {
            ...
            destroy: function() {
                return this.each(function() {
                    var e, i = t(this), o = i.data("sf-options");
                    if (!o)
                        return !1;
                    ...
                    o.$path.removeClass(o.hoverClass + " " + n.bcClass).addClass(o.pathClass),
...
function(t) {
    var e, n, i, o, r, s, a, l = "Close", c = "BeforeClose", u = "MarkupParse", p = "Open", f = "Change", d = "mfp", h = "." + d, g = "mfp-ready", m = "mfp-removing", v = "mfp-prevent-close", y = function() {}, b = !!window.jQuery, w = t(window), x = function(t, n) {
        e.ev.on(d + t + h, n)
    }, T = function(e, n, i, o) {
        var r = document.createElement("div");
    ...
    y.prototype = {
        ...
        open: function(n) {
            ...
            e.bgOverlay || (e.bgOverlay = T("bg").on("click" + h, function() {
                e.close()
            }),
        ...
        appendContent: function(t, n) {
            e.content = t,
            t ? e.st.showCloseBtn && e.st.closeBtnInside && !0 === e.currTemplate[n] ? e.content.find(".mfp-close").length || e.content.append(k()) : e.content = t : e.content = "",
            C("BeforeAppend"),
    ...
    ;
    var $, I, O, A = "inline", N = function() {
        O && (I.after(O.addClass($)).detach(),
        O = null)
    };
                ...
                var n = 0
                  ...
                  , o = function(r) {
                    ...
                    _ = setInterval(function() {
                        return i.naturalWidth > 0 ? void e._onImageHasSize(t) : (n > 200 && clearInterval(_),
                        n++,
                        void (3 === n ? o(10) : 40 === n ? o(50) : 100 === n && o(500)))
                    }, r)
                };
            ...
            return t(this).each(function() {
                ...
                if (e) {
                    ...
                    s.on("touchstart" + i, function(t) {
                        ...
                        l = p.clientX,
                        c = p.clientY,
                        w.on("touchmove" + i, function(t) {
                            p = t.originalEvent ? t.originalEvent.touches : t.touches,
                            f = p.length,
                            p = p[0],
                            (Math.abs(p.clientX - l) > 10 || Math.abs(p.clientY - c) > 10) && (u = !0,
                            n())
    ...
    var t = function() {
      ...
      , o = function() {
        ...
        $(window).resize(function() {
            ...
            t.width() > 769 && $("body").hasClass("fh5co-offcanvas") && $("body").removeClass("fh5co-offcanvas")
        })
    }
      , r = function() {
      ...
      , s = function() {
        ...
        $(".animate-box").waypoint(function(e) {
            "down" !== e || $(this.element).hasClass("animated") || (t++,
            $(this.element).addClass("item-animate"),
            setTimeout(function() {
